...
class ContableCompendioFacturasExport implements FromCollection, WithMapping, WithHeadings, WithTitle, ShouldAutoSize,  WithEvents
{
    ...
    {
        $titulo = 'COMPENDIO DE FACTURAS Y NOTAS '.$this->fecha;
        return [
            ['SOFER'],
            [$titulo],
            [''],
